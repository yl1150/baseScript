cc.Class({
    ...
    init(roundCtrl) {
        ...
        this._bird = this.node.getChildByName('bird').getComponent(sp.Skeleton);
        this.node.name = 'op';
        this._state = 'init';
    },
    ...
    touchStart(event) {
        ...
        let pos = cc.YL.tools.getRelativePos(game,this.node);
        ...
        this._bird.setAnimation(0,'animation3',true);
    },
    ...
    touchEnd(event) {
        this._bird.setAnimation(0,'animation2',true);
        this.node.setScale(1);
        if (!this._collision) {
            this.showBack();
            return;
    ...
    onCollisionEnter(other, self) {
        ...
        this._collision.setScale(1);
        if (this._collision != new_Colll) {
            this._collision = new_Colll;
        }
        this._collision.setScale(1.2);
    },
    ...
    showDown(collision) {
        ...
        this._bird.node.setParent(collision);
        this._bird.node.setPosition(0,-25);
        this._bird.node.zIndex = -1;
