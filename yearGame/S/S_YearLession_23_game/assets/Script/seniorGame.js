cc.Class({
    ...
    start() {
        ...
        this.kingSke = this.node.getChildByName('king').getComponent(sp.Skeleton);
        this.handSke = this.hand.getChildByName('shou').getComponent(sp.Skeleton);
        GD.sound.playBGM();
    ...
    registerEvent() {
        ...
        GD.sound.bindSpine(this.kingSke, 'animation2', 'animation3');

        cc.YL.emitter.on('CHANGEFINGER', (num) => {
            this.showChangeFinger(num);
        });
    },

    showChangeFinger(num) {
        this.handSke.setAnimation(0, 'shou_' + num, true);
    },
