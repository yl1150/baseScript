...
var Network = {
    ...
    //     var url = 'http://www.hxsup.com/api/annual/studyLog/add'
    //     if (cc.gameConfig.isDev) {
    //         url = 'http://dev.hxsup.com/api/annual/studyLog/add'
    //     }
    //     var header = {
    ...
    sendStarNum(starNum) {
        ...
        var url
        if (cc.gameConfig.isDev) {
            url = cc.gameConfig.devUrl + '/api/annual/userRecord/addIntegral'
        } else {
    ...
    sendTime(time) {
        ...
        var url
        if (cc.gameConfig.isDev) {
            url = cc.gameConfig.devUrl + '/api/annual/studyLog/add'
        } else {
    ...
    */
    ...
    getLearningProcess_App(cb) {
        var data = {
            practiceId: this.practiceId,
        }
        let urlHead = cc.gameConfig.isDev ? 'http://dev.hxsup.com' : 'http://www.hxsup.com'
