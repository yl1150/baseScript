cc.Class({
    ...
    startPlay() {
        ...
        //设置选项位置在竹竿上
        var worldpos = this.beam.convertToWorldSpaceAR(cc.v2(0, 0));
        var pos = this.options.parent.convertToNodeSpaceAR(worldpos);
    ...
    showResult(isWin = true) {
        ...
        function hint() {
            ...
            //天平摇晃后倾斜
            self.balance.getComponent('Balance').turnAfterShake(-1);
        }
    },
});