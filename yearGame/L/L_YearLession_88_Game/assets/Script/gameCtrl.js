...
cc.Class({
    ...
    showFinishLayer() {
        ...
        let num = this.rightNode.getChildByName('num');
        let pos = cc.YL.tools.getRelativePos(this.wenhao, num.parent);
        cc.tween(num)
            .then(cc.YL.aMgr.lineMove(num.position, pos, 0.05))
            .call(() => {
                this.wenhao.getComponent(cc.Sprite).spriteFrame = num.getComponent(cc.Sprite).spriteFrame;
