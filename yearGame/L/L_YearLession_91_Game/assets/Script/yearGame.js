cc.Class({
    ...
    start() {
        ...
        //展示七巧板出现
        this.robot.setAnimation(0, 'zhankai', false);
        this.robot.addAnimation(0, 'daiji', true);
    ...
    registerEvent() {
        ...
        cc.YL.emitter.on('showTX', (skin) => {
            cc.YL.lockTouch();
            this.robot.setSkin(skin);
            this.robot.setAnimation(0, 'daiji', true);
            cc.YL.timeOut(() => {
                cc.YL.unLockTouch();
                this.robot.setSkin('quan');
                this.robot.setAnimation(0, 'daiji', true);
            }, 1000)
        })
    },
